...
function TextBox({ children }) {
  return (
    <div className="flex text-center text-black font-pretendard tracking-[-0.07em] text-xs font-semibold lg:text-xl">
      {children}
    </div>
  );
}
    ...
    <div className="sticky left-0 right-0 top-0 z-50 border-b border-neutral-300">
      <div className="flex flex-row items-center justify-between p-4 bg-white">
        <Link to={"/"} className="flex items-center ">
          ...
          <div className="text-center text-[#333333] font-pretendard tracking-[-0.02em] text-lg font-bold">
            세종 그리디콘
          </div>
        </Link>
