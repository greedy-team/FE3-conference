    ...
    <div className="sticky left-0 right-0 top-0 z-50 border-b border-neutral-300">
      <div className="flex flex-row items-center p-4 bg-white">
        <div className="flex items-center">
          ...
          <div className="text-center text-black font-pretendard tracking-[-0.02em] text-[18pt] font-bold">
            세종 그리디콘
          </div>
        </div>

        <div className="flex-1 flex flex-col p-2 lg:hidden max-[344px]:hidden">
          <div className="flex-1 text-center border-b border-black" />
          <div className="flex-1 text-center" />
        </div>

        <div className="text-center text-black tracking-[-0.07em] text-[18pt] font-bold lg:hidden max-[344px]:hidden">
          11.19-11.20
        </div>
      </div>
    </div>
