    ...
    <main className="bg-gray-50 min-h-screen">
      <div className="bg-white mx-auto max-w-5xl px-6 sm:px-8 lg:px-12 py-8 sm:py-12">
        ...
        <div className="flex flex-col gap-6 sm:gap-8">
          <div className="w-full aspect-square max-w-[700px] mx-auto relative bg-[#007354] rounded-3xl backdrop-blur-[2px] flex justify-center items-end overflow-hidden">
            <img className="w-full h-full object-contain absolute top-0 left-0" src={brickBg} alt="배경" />
            <img className="w-[20%] max-w-[200px] h-auto relative z-10 rounded-[34px] mb-4" src={giraffe} alt="기린" />
          </div>

          <div className="p-6 sm:p-8 bg-white rounded-2xl border border-[#E5E5E5] flex flex-col gap-6">
            <div className="flex flex-col gap-3">
              <div className="flex justify-between items-center">
                <div className="text-black text-base sm:text-lg font-bold font-['Inter']">마지막 응모권 번호</div>
              ...
              <input
                ...
                placeholder="ex) 143"
                className="w-full px-4 py-3.5 bg-white rounded-lg border border-[#E5E5E5] text-black text-base font-normal font-['Inter'] focus:outline-none focus:border-[#007354]"
              />
            </div>
            <button
              onClick={showLotteryResult}
              className="w-full py-3.5 bg-[#007354] rounded-lg flex justify-center items-center cursor-pointer hover:bg-[#005a42] transition-colors"
            >
              <span className="text-white text-base sm:text-lg font-medium font-['Inter']">시작</span>
            </button>
          </div>
        </div>
      </div>
