      ...
      <div className="mx-auto max-w-5xl px-6 sm:px-8 lg:px-12 pt-8 pb-6 sm:py-12 bg-gray-30 sm:bg-white">
        ...
        <div className="flex flex-col gap-4 sm:gap-5">
          <div className="w-full aspect-[1222/1163] max-w-[500px] mx-auto relative bg-[#007354] rounded-3xl backdrop-blur-[2px] flex justify-center items-end overflow-hidden">
            ...
            <img className="w-[18%] h-auto relative z-10 rounded-[34px] mb-2" src={giraffe} alt="기린" />
          </div>

          <div className="p-5 sm:p-6 bg-white rounded-2xl border border-[#E5E5E5] flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                <div className="text-black text-sm sm:text-base font-bold font-['Inter']">마지막 응모권 번호</div>
            ...
            >
              <span className="text-white text-base font-medium font-['Inter']">시작</span>
            </button>
          </div>
        </div>
      </div>
